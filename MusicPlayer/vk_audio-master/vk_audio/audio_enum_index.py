...
class AudioEnumIndex(object):
    ...
    def _get_script_from_url(self, src: str):
        ...
        for i in match.split(','):
            ...
            val = int(val)
            if (i[0] == 'AUDIO_ITEM_INDEX_ID'):
                self.AUDIO_ITEM_INDEX_ID = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_OWNER_ID'):
                self.AUDIO_ITEM_INDEX_OWNER_ID = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_URL'):
                self.AUDIO_ITEM_INDEX_URL = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_PERFORMER'):
                self.AUDIO_ITEM_INDEX_ARTIST = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_TITLE'):
                self.AUDIO_ITEM_INDEX_TITLE = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_DURATION'):
                self.AUDIO_ITEM_INDEX_DURATION = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_ALBUM_ID'):
                self.AUDIO_ITEM_INDEX_ALBUM_ID = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_AUTHOR_LINK'):
                self.AUDIO_ITEM_INDEX_AUTHOR_LINK = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_LYRICS'):
                self.AUDIO_ITEM_INDEX_LYRICS = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_COVER_URL'):
                self.AUDIO_ITEM_INDEX_COVER_URL = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_MAIN_ARTISTS'):
                self.AUDIO_ITEM_INDEX_MAIN_ARTISTS = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_HASHES'):
                self.AUDIO_ITEM_INDEX_HASHES = val
            elif (i[0] == 'AUDIO_ITEM_INDEX_TRACK_CODE'):
                self.AUDIO_ITEM_INDEX_TRACK_CODE = val;
            elif (i[0] == 'AUDIO_ITEM_INDEX_ALBUM'):
                self.AUDIO_ITEM_INDEX_ALBUM = val;
        s = self._get_hash(text, 'actionHash');
