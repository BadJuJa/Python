...
class CustomGrip(QWidget):
    def __init__(self, parent, position, grip_width=10, disable_color=True):
        # SETUP UI
        self.grip_width = grip_width
        QWidget.__init__(self)
        self.parent = parent
        self.setParent(parent)
        self.wi = Widgets(self.grip_width)
        ...
        # SHOW LEFT GRIP
            ...
            self.wi.left(self)
            self.setGeometry(0, self.grip_width, self.grip_width, self.parent.height())
        ...
        # RESIZE RIGHT
            ...
            self.wi.right(self)
            self.setGeometry(self.parent.width() - self.grip_width, self.grip_width, self.grip_width, self.parent.height())
            self.setMaximumWidth(self.grip_width)
    ...
    def resizeEvent(self, event):
        if hasattr(self.wi, 'container_top'):
            self.wi.container_top.setGeometry(0, 0, self.width(), self.grip_width)

        elif hasattr(self.wi, 'container_bottom'):
            self.wi.container_bottom.setGeometry(0, 0, self.width(), self.grip_width)

        elif hasattr(self.wi, 'leftgrip'):
            self.wi.leftgrip.setGeometry(0, 0, self.grip_width, self.height() - 20)

        elif hasattr(self.wi, 'rightgrip'):
            self.wi.rightgrip.setGeometry(0, 0, self.grip_width, self.height() - 20)
...
class Widgets(object):
    ...
    def top(self, Form):
        ...
        self.container_top.setGeometry(QRect(0, 0, 500, self.grip_width))
        self.container_top.setMinimumSize(QSize(0, self.grip_width))
        self.container_top.setMaximumSize(QSize(16777215, self.grip_width))
        ...
        self.top_left.setMinimumSize(QSize(self.grip_width, self.grip_width))
        self.top_left.setMaximumSize(QSize(self.grip_width, self.grip_width))
        ...
        self.top_right.setMinimumSize(QSize(self.grip_width, self.grip_width))
        self.top_right.setMaximumSize(QSize(self.grip_width, self.grip_width))
    ...
    def bottom(self, Form):
        ...
        self.bottom_left.setMinimumSize(QSize(self.grip_width, self.grip_width))
        self.bottom_left.setMaximumSize(QSize(self.grip_width, self.grip_width))
    ...
    def left(self, Form):
        ...
        self.leftgrip.setGeometry(QRect(0, self.grip_width, self.grip_width, 480))
        self.leftgrip.setMinimumSize(QSize(self.grip_width, 0))
    ...
    def right(self, Form):
        ...
        self.rightgrip.setGeometry(QRect(0, 0, self.grip_width, 500))
        self.rightgrip.setMinimumSize(QSize(self.grip_width, 0))
